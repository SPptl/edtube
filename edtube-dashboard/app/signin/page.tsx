      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-2xl border border-gray-800 bg-[#212121] backdrop-blur">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-white text-balance">Welcome Back</CardTitle>
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <Link href="/forgot-password" className="text-red-500 hover:text-red-400 hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center text-sm text-gray-400">
              ...
              <Link href="/signup" className="text-red-500 hover:text-red-400 hover:underline font-medium">
                Sign up
              </Link>
            </div>
          </CardContent>
